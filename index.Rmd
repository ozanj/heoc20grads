...
`r create_img('conniec-collage.jpg', style='height:98%;transform:translate(15px, -15px);')`

*** =right

`r create_textbox("Thank you to the HEOC faculty and friends, especially Mitch, for believing in and supporting me. It's been an honor to learn from each and everyone of you. I will carry with me the important lessons of critical research, empathy, and advocacy for social change.", style='width:225px;transform:translateX(15px);')`
